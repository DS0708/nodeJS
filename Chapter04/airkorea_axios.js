...
app.get('/airkorea', async (req, res) => {
    const serviceKey = "Aqujd4FK4LwLmpLxu7TiyLpB86MY8K7Gaz2WjN0BYPVKzFAb9CREpu6xJz%2F8vq9LNS4JCkK48P1lFWWWWA9C7Q%3D%3D"; //"일반인증키(Encoding)";
    ...
    try {
        ...
        res.json(result.data); // axios로 받은 결과는 .data 필수
    } catch (error) {
        console.log(error);
    }
});
